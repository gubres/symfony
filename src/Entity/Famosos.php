...
class Famosos
{
    ...
    {
        $zonaHoraria = new DateTimeZone('Europe/Madrid'); // Ajusta a tu zona horaria
        $this->creado = new DateTimeImmutable('now', $zonaHoraria);
        $this->modificado = new DateTimeImmutable('now', $zonaHoraria);
        $this->eliminado = false; // Asume que el nuevo registro no está eliminado
    }
    ...
    public function setModificado ( DateTimeImmutable $modificado): self
    {
    ...
    public function prePersist(): void
    {
        ...
        if (!$this->modificado) {
            $this->modificado = new DateTimeImmutable();
        }
    }
